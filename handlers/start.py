...
async def send_teamleads(message: types.Message):
    ...
    text = 'Привет! \n' \
           ...
           '<b>Лиды направлений:</b>\n' \
           '@yuuumei — Фаррух - лидер Backend (и Глеб @Glebser9)\n' \
           '@Lolkek77rus  - Иван - лидер FrontEnd\n' \
           '@Ruslan_0691 - Руслан и @NataliaOshmarina - Наталья - лидеры DS/ML\n' \
           '@abstraducks - Лиза - лидер Дизайна\n' \
           '@EvdokimovDenis - Денис - временно лидер IOS разработки\n' \
           '@jdefey - Андрей - лидер Android разработки\n' \
           '@Big_Brother_IT - Карен - лидер контроля\n' \
           '@poddubniysergey198  - Сергей - лидер отдела Адаптации\n' \
           '@johnnyknoxvil - лидер отдела тестирования и безопасности\n' \
           '@aanatyrnal - Ангелина и @MicoDi - Мила - по общим вопросам'
    await message.answer(text,
